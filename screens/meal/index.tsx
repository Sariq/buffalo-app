...
const extrasIcons = {
  'وزن': require("../../assets/menu/gradiant/burgerSlice.png"),
  "شيدر": require("../../assets/menu/gradiant/cheese.png"),
  "باكون خروف": require("../../assets/menu/gradiant/baecon.png"),
  "انتريكوت": require("../../assets/menu/gradiant/antrecot.png"),
  "باكون عجل": require("../../assets/menu/gradiant/baecon-buffalo.png"),
  "هالبينو": require("../../assets/menu/gradiant/jalapeno.png"),
  "بيض عيون": require("../../assets/menu/gradiant/egg.png"),
  "فقع بورتوبيللو": require("../../assets/menu/gradiant/truffle.png"),
  "بصل مقلي": require("../../assets/menu/gradiant/friedOnion.png"),
  "مايونيز": require("../../assets/menu/gradiant/maio.png"),
  "بندورة": require("../../assets/menu/gradiant/tomatto.png"),
  "خس": require("../../assets/menu/gradiant/khs.png"),
  "خيار مخلل": require("../../assets/menu/gradiant/pickels.png"),
  "بصل": require("../../assets/menu/gradiant/onion.png"),
  "كاتشب": require("../../assets/menu/gradiant/ketchup.png"),
  "سريراتشا": require("../../assets/menu/gradiant/sersachi.png"),
  "باربيكيو": require("../../assets/menu/gradiant/barbicu.png"),
  "خردل": require("../../assets/menu/gradiant/musterd.png"),
  "اضافة كرسبي": require("../../assets/menu/gradiant/crispy-chicken.png"),
  "موتزريلا": require("../../assets/menu/gradiant/mozerla.png"),
  "تشيلي حلو": require("../../assets/menu/gradiant/sweet-chilli.png"),
  "روطف بافلو": require("../../assets/menu/gradiant/buffalo-souce.png"),
  "רוטב נאגטס": require("../../assets/menu/gradiant/sweet-chilli.png"),
  "جبنة الجاودا": require("../../assets/menu/gradiant/gaouda.png"),
  "حلقات البصل": require("../../assets/menu/gradiant/onion-ring.png"),
  "قطع بالمنتصف": require("../../assets/menu/gradiant/cut.png"),
  "ايولي ثوم كونفي": require("../../assets/menu/gradiant/ayolethom.png"),
  "فلفل اخضر": require("../../assets/menu/gradiant/flflakhdr.png"),
};
